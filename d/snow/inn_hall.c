...
LONG
	...
	set("no_fight",1);
	set("detail", ([ /* sizeof() == 8 */
		"酒缸" : "你仔細地瞧了瞧酒缸上貼的紅紙﹐不得了﹐有延德年間的高粱﹐京
城廖痲子酒坊火漆封印的「拔舌酒」﹐有四季紅的一品醉美人﹐還
有好幾罈貼著西郊大鼓樓的陳年老酒。
",
		"燈籠" : "一串紙糊的大燈籠高高地掛在屋前的旗杆上﹐共是五個﹐分別寫著
「飲風客棧」四個大字﹐最下面的燈籠畫著一個葫蘆。
",
		"桌椅" : "這些桌椅零零散散地放置在客棧的廳中﹐看來相當老舊了。
",
		"樓梯" : "這道樓梯通往二樓的雅座跟客房。
",
		"竹簾" : "竹簾用來隔開客人用膳跟廚房的爐灶﹐但是擋不住從廚房飄出來的
香氣。
",
		"櫃臺" : "櫃臺後面陳列著一罈罈貼著紅紙條的酒缸﹐這些是客棧掌櫃視如性
命的陳年老酒﹐如果你有興趣﹐不妨問問掌櫃有關這些陳年老酒賣
是不賣。
",
		"west" : (: look_door,     "west" :),
		"east" : (: look_door,     "east" :),
